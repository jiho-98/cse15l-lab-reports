...
*`HandleRequest`: This method is called when the server receives an HTTP request from a client. It takes a URI object representing the URL of the request and returns a *`String`: representing the response to send back to the client.
